...
<head>
    ...
    <!-- External CSS-->
    <link rel="stylesheet" type="text/css" href="../../resoruces/css/board/html_checking_div.css">
    <link rel="stylesheet" type="text/css" href="../../resoruces/css/board/reviewBoardList.css">
