    ...
    <div class="main_bg">
        <div class="main_content">
            ...
            <form action="insert" method="POST" enctype="multipart/form-data" role="form">
                ...
                <input type="text" class="prod-input-min" name="roomName" id="roomName" required>
                <div style="padding: 10px;"></div>

                <div class="prod-text" >설명</div>
                <textarea class="prod-textarea" name="roomAbout" id="roomAbout" required></textarea>
                <div style="padding: 10px;"></div>

                <div class="prod-text" >구성</div>
                <input type="text" class="prod-input-med" name="roomConfig" id="roomConfig" required>
                <div style="padding: 10px;"></div>

                <div class="prod-text">정상가</div>
                <input type="number" class="prod-input-min" name="roomPrice" id="roomPrice" required>
                <div style="padding: 10px;"></div>
                
                <div class="prod-text">할인률</div>
                <input type="number" class="prod-input-min" name="roomDiscount" id="roomDiscount" value="0"  required>
                <div style="padding: 10px;"></div>
