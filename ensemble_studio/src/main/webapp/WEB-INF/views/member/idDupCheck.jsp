...
<body>
	...
	<script>
		...
		// "${result}"; : 값이 빈칸일때 오류가 뜨기 때문에 문자열로 인식하려고 ""를 씀
		
		// 현재 문서가 로드가 완료된 후 동작 (레디함수)
		$(function(){
			...
			if(result == ""){ // 최초 팝업창 오픈 시 
				...
				// opener.document.signUpForm : 부모창 내부 HTML 문서 중 name 속성이 signUpForm인 요소
		...
		function confirmId(){
			...
			// 2. 아이디 중복검사 진행 여부를 확인하기 위한 hidden 타입 태그값 변경
			// 3. 팝업창 닫기
