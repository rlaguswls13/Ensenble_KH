		...
		<div class="secession-form">
			<form action="secession" method="post"
				...
				<c:if test="${loginMember.memberPath == 'S'}">
					<input type="hidden" name="currentPwd" value="naverpassword">
				</c:if>
				...
				<div class="form-group agree-form">
					<table class="checkbox_group">
						<tr>
							<td class="agree-text">[회원탈퇴 약관]<br> <br> 회원탈퇴 신청
								전 안내 사항을 확인해 주세요.<br> 회원탈퇴를 신청하시면 현재 로그인 된 아이디는 사용하실 수
								없습니다.<br> 회원탈퇴를 하더라도, 서비스 약관 및 개인정보 취급방침 동의하에 따라 일정 기간동안 회원
								개인정보를 보관합니다.<br> <br> - 회원 정보<br> - 상품 예약에 관한 기록<br>
								- 소비자 불만 또는 처리 과정에 관한 기록<br> - 게시판 작성 및 사용후기에 관한 기록<br>
								<br> ※ 상세한 내용은 사이트 내 개인정보 취급방침을 참고해 주세요.
				...
				<input type="checkbox" id="check_all" name="agree"> <label
					for="check_all"></label> <span
					style="font-size: 10pt; color: black" id="check-mark">탈퇴 약관에
					동의하며 이의를 제기하지 않겠습니다.</span>
